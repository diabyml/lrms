...
const RistourneFormPage: React.FC = () => {
  ...
  const handleUpdateSuccess = () => {
    // navigate back to this ristourne page
    // refech this page datas
    // window.location.reload();
    if (isEditMode) {
      navigate(`/ristournes/${ristourneId}`);
    } else {
      navigate(`/ristournes/new`);
    }
  };
                ...
                <Table>
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="print:hidden text-red-600">
                        Restant
                      </TableHead>
                          ...
                          >
                            {result.unpaid_amount ? (
                              <span className="text-red-600">
                                {result.unpaid_amount} FCFA{" "}
                              </span>
                            ) : (
                              <span className="text-"> 0 FCFA </span>
                            )}
                          </TableCell>
