...
import HemocultureMainContent from "./HemocultureMainContent";
...
// --- Component ---
const HemoculturePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="report-content bg-white  p-4 sm:p-6 border border-transparent print:border-none print:p-0 print:shadow-none">
        ...
        <div className="print:grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6  print:grid-cols-2 hidden ">
          {/* Patient Info */}
        ...
        {/* content here */}
        <HemocultureMainContent resultId={resultData.id} />
      </div>{" "}
...
// // receives resultId as prop
// const MainContent = ({ resultId }: { resultId: string }) => {
//   return <>MAIN PAGE: {resultId} </>;
// };

export default HemoculturePage;
