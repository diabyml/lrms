...
export function MainPageContent({ resultId }: Props) {
            ...
            if (insertError) {
                ...
                if (insertError.code === "23505" || (insertError.message && insertError.message.includes("duplicate key value"))) {
                    const { data: retryData, error: retryError } = await supabase
                        ...
                        .maybeSingle();
                    if (retryError) {
                        setError("Erreur lors du chargement après duplication: " + retryError.message);
                    } else if (retryData) {
                        ...
                        setError("Erreur inattendue lors de la récupération après duplication.");
                    }
                } else {
    ...
    return (
        <>
            ...
            >
                <h1 className="text-2xl font-bold text-center mb-6 uppercase print:text-[20pt] print:mb-8 print:font-bold">EXAMEN ANATOMO-PATHOLOGIQUE</h1>
                <div className="mb-4 print:mb-6">
                    <h2 className="font-bold mb-2 print:mb-1 print:text-[17pt] uppercase">Résumé de l’Observation Clinique :</h2>
                    <div className="ml-4 space-y-2 print:ml-0 print:space-y-1">
                        <div>
                            Diagnostic Clinique :
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.diagnostic_clinique}</span>
                                <input
                        ...
                        <div>
                            ...
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.biopsie_chirurgicale}</span>
                                <input
                        ...
                        <div>
                            Fixateur Utilisé :
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.fixateur_utilise}</span>
                                <input
                ...
                <div className="mb-4 print:mb-6">
                    <h2 className="font-bold mb-2 uppercase print:mb-1 print:text-[17pt]">COMPTE –RENDU HISTOPATHOLOGIQUE :</h2>
                    <div className="ml-4 space-y-2 print:ml-0 print:space-y-1">
                        <div>
                            <span className="font-bold print:text-[16pt]">I. Etude Macroscopique :</span>
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.etude_macroscopique}</span>
                                <textarea
                        ...
                        <div>
                            <span className="font-bold print:text-[16pt]">2-Etude Histologique :</span>
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.etude_histologique}</span>
                                <textarea
                        ...
                        <div>
                            <span className="font-bold underline print:text-[16pt]">3-Conclusion :</span>
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.conclusion}</span>
                                <textarea
                                    name="conclusion"
                        ...
                        <div>
                            <span className="print:inline print:ml-1">
                                <span className="hidden print:inline print:text-[16pt]">{fields.bottom_text}</span>
                                <textarea
                                    name="bottom_text"
                ...
                <div className="mt-8 flex flex-col items-end print:mt-12 print:items-end">
                    <span className="print:text-[15pt]">
                        <span className="hidden print:inline">{signatureFields.cityDate}</span>
                        <input
                            name="cityDate"
                    ...
                    <span className="print:text-[15pt]">
                        <span className="hidden print:inline">{signatureFields.doctor}</span>
                        <input
                            name="doctor"
                ...
                <div className="mt-6 flex items-center gap-4 print:hidden">
                    ...
                    {saveMsg && <span className={saveMsg.startsWith("Erreur") ? "text-red-500" : "text-green-600"}>{saveMsg}</span>}
                </div>
            </div>
