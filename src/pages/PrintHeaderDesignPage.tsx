...
const availableHeaderTemplates: HeaderTemplateOption[] = [
  { id: "template1", name: "Classique (Sans Logo)", component: Template1 },
  { id: "template2", name: "Centré (Logo au Dessus)", component: Template2 },
  { id: "template3", name: "Centré (encercle)", component: Template3 }, // Add Template 3
  { id: "template4", name: "Centré (encercle en %)", component: Template4 }, // Add Template 4
];
